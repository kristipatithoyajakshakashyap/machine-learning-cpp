...
threshold is calibrated as the 95th percentile of the *validation* scores, and the untouched test
...
therefore report score distributions and flag rates, never precision or recall, and the reports say
so. Species labels are not anomaly ground truth and are never used for fitting or calibration.
