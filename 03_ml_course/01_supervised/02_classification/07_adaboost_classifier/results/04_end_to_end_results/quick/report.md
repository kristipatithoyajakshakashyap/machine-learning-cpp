...
Training rows: 319; untouched test rows: 81. 5 folds selected parameter 100 using macro F1.

Holdout macro F1: 0.973143. Bootstrap 95% percentile interval [0.929894, 1]. These intervals describe sampling variation conditional on this fitted model, not repeated model-selection uncertainty.
