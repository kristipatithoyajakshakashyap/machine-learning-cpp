...
| [`03_svm_classification`](03_svm_classification/README.md) | `csvm_*` | Maximum-margin boundary with hinge loss; RBF kernel |
...
| [`10_model_evaluation`](10_model_evaluation/README.md) | `eval_*` | Metrics, curves, and the holdout/CV discipline; model-family selection |
