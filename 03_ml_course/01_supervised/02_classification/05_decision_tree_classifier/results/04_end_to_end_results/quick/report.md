...
Training rows: 319; untouched test rows: 81. 5 folds selected parameter 4 using macro F1.

Holdout macro F1: 0.947742. Bootstrap 95% percentile interval [0.888889, 0.987463]. These intervals describe sampling variation conditional on this fitted model, not repeated model-selection uncertainty.
