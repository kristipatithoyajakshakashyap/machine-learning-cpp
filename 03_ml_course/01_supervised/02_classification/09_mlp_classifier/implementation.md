# mlp classifier — implementation walkthrough

Model interfaces: MLP.hpp. Fit stores learned state; predict uses that state without updating it. The numbered implementation lesson is a small API example. The final lesson calls the shared C++ supervised runner.
