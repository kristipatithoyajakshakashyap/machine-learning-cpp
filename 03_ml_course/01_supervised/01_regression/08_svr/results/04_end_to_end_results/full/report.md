...
Training rows: 353; untouched test rows: 89. 5 folds selected parameter 1 using negative RMSE.

Holdout RMSE: 64.3873. Bootstrap 95% percentile interval [54.1291, 74.2575]. These intervals describe sampling variation conditional on this fitted model, not repeated model-selection uncertainty.
